...
public class Samplingsite {
 ...
 public Samplingsite(String name, int province_id, int district_id, int canton_id, int entity_id){
 ...
 public Samplingsite(int id, String name, int province_id, int district_id, int canton_id, int entity_id){
